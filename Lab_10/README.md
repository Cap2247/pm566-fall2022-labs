...
Exercise 4 Exercise 4.1 Construct a query that retrives all rows from
the payment table where the amount is either 1.99, 7.99, 9.99.
...
Exercise 6 Exercise 6.1 Use COUNT(\*) to count the number of rows in
rental
